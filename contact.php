...
// Email configuration
$from = 'Email received from <inf@yourdomain.com>';
$sendTo = 'Email sent to <inf@yourdomain.com>';
$subject = 'You have received a new email';
$fields = array('name' => 'Name', 'surname' => 'Surname', 'phone' => 'Phone', 'email' => 'Email', 'message' => 'Message'); // array variable name => Text to appear in the email
$okMessage = 'Your message has been sent, we will get back to you shortly!';
